...
On December 12, 2008, TechCrunch reported that AdSense for Domains is available for all US publishers.[14]

On February 22, 2012, Google announced that it was shutting down its Hosted AdSense for Domains program.[15]
AdSense for video

AdSense for video allows publishers with video content to generate revenue using ad placements from Google's extensive advertising network including popular YouTube videos.[16]
...
There have also been reports of Trojan horses engineered to produce counterfeit Google advertisements that are formatted looking like legitimate ones. The Trojan uploads itself onto an unsuspecting user's computer through a webpage and then replaces the original advertisements with its own set of malicious advertisements.[22]

Furthermore websites having copyright content do not qualify Adsense's quality guidelines. Copyrighted content consists of any kind of content including music, videos, text and any other thing. DMCA handles copyright issues regarding any kind of digital content, if some website took down by DMCA complaint, Adsense ads stop viewing on that page under copyright infringement. [23]
